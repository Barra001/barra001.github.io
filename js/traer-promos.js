...
async function reqListener() {
  ...
  for (let cont = 0;cont<rows.length;cont=cont+1) {
    ...
    cards[cont].innerHTML+='<div class="image subir"><img src="img/discount-tagg.png" height="175" width="175"></div> <div class="image2 subir"><img height="175" src="img/discount-tagg.png" ' +
