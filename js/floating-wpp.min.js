...
theButton.addEventListener("click", async function () {
    if (pressed) {
        ...
        await sleep(300)
        theButton.innerHTML = '<div onclick="copyNumber()" id="wpNumber"><span class="tooltiptext" id="myTooltip">Copiar</span>'+num+'</div><a href="https://api.whatsapp.com/send?phone=598097063691&text="><button id="whatBut" class="mt-1">Enviar Mensaje</button></a> '
        pressed =true
    }
